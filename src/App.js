...
const UserHint = ({loading, hintText}) => (
  <div className="user-hint">
    ...
    {loading ? (
      <img className="block mx-auto" src={loader} alt="loader" />
    ) : (
      hintText
    )}
  </div>
  ...
  searchGiphy = async searchTerm => {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.giphy.com/v1/gifs/search?api_key=TYauWypYOOlR2bvXeblQTb7qFd1a4sxW&q=${searchTerm}&limit=25&offset=0&rating=G&lang=en`
      )
